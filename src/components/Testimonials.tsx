...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="testimonials-enhanced bg-white dark:bg-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="page-header-enhanced text-center">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            ...
            <span className="text-primary-600 dark:text-primary-400 block">About Our Services</span>
          </h2>
        ...
        <div className="section-enhanced-spacing grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="group">
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 lg:p-8 border-2 border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-xl hover:border-primary-300 dark:hover:border-primary-600 transition-all duration-300 transform hover:-translate-y-1 h-full relative overflow-hidden">
                {/* Quote Icon */}
                ...
                <div className="flex items-center space-x-1 mb-6">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <Star key={i} className="h-5 w-5 text-primary-500 dark:text-primary-400 fill-current" />
                  ))}
                </div>
                ...
                <div className="flex items-center space-x-4">
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 rounded-full bg-primary-500 dark:bg-primary-600 flex items-center justify-center">
        ...
        {/* Trust Indicators */}
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 md:p-12 border-2 border-gray-200 dark:border-gray-700 shadow-lg text-center">
